...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['document_file'])) {
    ...
    if ($conn && !$conn->connect_error) {
        ...
        // अगर uploads फ़ोल्डर नहीं है, तो बना दें
        if (!file_exists($target_dir)) {
            mkdir($target_dir, 0777, true);
        }

        // फ़ाइल का असली नाम और एक्सटेंशन लें
        ...
        if (!$is_graphic_image) {
            ...
            if (move_uploaded_file($_FILES["document_file"]["tmp_name"], $target_file)) {
                ...
                // 🔥 सीधे `verify/verification_result.php` पर रीडायरेक्ट करें
                header("Location: verify/verification_result.php?id=98");
                exit();
            } else {
...
<head>
    ...
    <title>Upload Identity Document | DigiVerify</title>
