...
// Instant session validation check
...
// High-speed optimized login query
if(isset($_POST['login'])){

    $email = mysqli_real_escape_string($conn, trim($_POST['email']));
    $password = mysqli_real_escape_string($conn, trim($_POST['password']));

    $sql = "SELECT id, fullname, email, role FROM subadmins
            WHERE email='$email'
    ...
    <div class="card-body-custom">
        ...
        <form method="POST" autocomplete="off">
            <div class="form-group-custom">
                ...
                <input type="email" name="email" class="form-input-custom" placeholder="Enter Sub Admin Email" autocomplete="new-password" required>
            </div>

            <div class="form-group-custom">
                <label>Password</label>
                <input type="password" name="password" class="form-input-custom" placeholder="Enter Password" autocomplete="new-password" required>
            </div>
