...
if (
    ...
    */
    ...
    IMPORTANT:
    These values are NOT fabricated as successful UIDAI verification.
    Actual online Aadhaar authentication/e-KYC requires an authorized
    KUA/AUA + ASA integration and UIDAI-approved credentials.
    Therefore this local project defaults to NOT_CHECKED.
    =====================================================
    */
